...
<html lang="en">
    ...
    <section class="probootstrap-cover overflow-hidden relative"  style="background-image: url(<?php echo base_url().'assets/images/backg.jpg'; ?>);" data-stellar-background-ratio="0.5" id="section-home">
      <div class="overlay"></div>
      <div class="container">
        <div class="row align-items-center text-center">
          <div class="col-md">
            <h2 class="heading mb-2 display-4 font-light probootstrap-animate"><img height="400px" width="400px" src="<?php echo base_url(). 'assets/images/gbf1.png'; ?>"></h2><br/> 
           <!-- <p class="probootstrap-animate">
              <a href="<?php echo base_url(). 'Welcome/profile'; ?>" role="button" class="btn btn-primary p-3 mr-3 pl-5 pr-5 text-uppercase d-lg-inline d-md-inline d-sm-block d-block mb-3">About GBF</a>
            </p>-->
          </div> 
        </div>
      </div>
...
-->
    ...
    <section class="probootstrap_section">
      <div class="container">
        <div class="row text-center mb-5 probootstrap-animate">
          <div class="col-md-12">
            <h2 class="display-4 border-bottom probootstrap-section-heading">Welcome to GBF</h2>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="probootstrap-section-half d-md-flex" id="section-about">
      ...
      <div class="probootstrap-text">
        <div class="probootstrap-inner probootstrap-animate" data-animate-effect="fadeInRight">
          ...
          <p>Gienz Bird Farm memiliki salah satu bisnis utama yaitu sebagai breeder burung untuk jenis murai, kenari, dan lovebird. </p>
          <p>Setiap burung yang diternakkan disini merupakan kualitas terbaik dengan perawatan dan penanganan yang professional</p>
    ...
    <section class="probootstrap_section">
      <div class="container">
        <div class="row text-center mb-5 probootstrap-animate">
          <div class="col-md-12">
            <h2 class="display-4 border-bottom probootstrap-section-heading">GBF Gallery</h2>
          </div>
        </div>
...
<!--
    <section class="probootstrap_section">
      <div class="container">
        <div class="row text-center mb-5 probootstrap-animate">
          <div class="col-md-12">
            <h2 class="display-4 border-bottom probootstrap-section-heading">GBF Accessories Look like</h2>
          </div>
        </div>
          ...
          <div class="col-md-12">
            <div class="owl-carousel js-owl-carousel">
              <a class="probootstrap-slide" href="#">
                <span><img height="100px" width="30px" src="<?php echo base_url().'assets/images/kaos.png'; ?>"></span>
                <em>Kaos GBF Crew</em>
              </a>
              <a class="probootstrap-slide" href="#">
...
<!--
    ...
    <section class="probootstrap_section" id="section-feature-testimonial">
      <div class="container">
        <div class="row justify-content-center mb-5">
          <div class="col-md-12 text-center mb-5 probootstrap-animate">
            <h2 class="display-4 border-bottom probootstrap-section-heading">GBF Leader's</h2>
            <blockquote class="">
              <p class="lead mb-4"><em>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean. A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country, in which roasted parts of sentences fly into your mouth.</em></p>
              <p class="probootstrap-author">
                <a href="https://uicookies.com/" target="_blank">
                  <img src="assets/images/person_1.jpg" alt="Free Template by uicookies.com" class="rounded-circle">
                  <span class="probootstrap-name">Gigih Herwibowo</span>
                  <span class="probootstrap-title">Founder of Gienz Bird Farm</span>
                </a>
              </p>
            </blockquote>
...
-->
    <section class="probootstrap_section bg-light">
      <div class="container">
        <div class="row text-center mb-5 probootstrap-animate">
          <div class="col-md-12">
            <h2 class="display-4 border-bottom probootstrap-section-heading">News From GBF</h2>
          </div>
        </div>
        <div class="row">
            <?php 
