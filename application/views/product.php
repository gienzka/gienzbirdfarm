   ...
   <section class="probootstrap-cover overflow-hidden relative"  style="background-image: url('<?php echo base_url().'assets/images/babybird.JPG'; ?>');" data-stellar-background-ratio="0.5" id="section-home">
      ...
      <div class="container">
        <div class="row align-items-center text-center">
          <div class="col-md">
            <h2 class="heading mb-2 display-4 font-light probootstrap-animate">GBF Birds</h2>
            <p class="lead mb-5 probootstrap-animate">Kami memiliki tiga jenis ternak utama</p>
