...
<html lang="en">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="probootstrap-menu">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item active"><a class="nav-link" href="<?php echo base_url(). 'Welcome/book'; ?>" >Birds</a></li>
    ...
    <!-- END nav -->
     ...
     <section class="probootstrap-cover overflow-hidden relative"  style="background-image: url('<?php echo base_url().'assets/images/home.jpg'; ?>');" data-stellar-background-ratio="0.5" id="section-home">
      ...
      <div class="container">
        <div class="row justify-content-center mb-5">
          <div class="col-md-12 text-center mb-5 probootstrap-animate">
            ...
            <blockquote class="">
              <p class="lead mb-4"><em>Penangkaran Gienz Bird farm (GBF) merupakan penangkaran burung terutama untuk jenis burung  Murai Batu, Kenari (jenis Yorshire) dan Lovebird.<br/> Untuk burung <b>murai batu</b> Gienz Bird farm memiliki indukan yang berkualitas yang sudah pernah mendapatkan juara dalam beberapa even kejuaraan lokal dan regional. Indukan murai batu jantan yaitu jenis murai batu medan, bahorok dan marike. Sedangkan indukan murai batu betina yaitu jenis murai batu medan.<br/> 
Untuk burung <b>kenari</b>, indukan jantan berasal dari Negara lain (impor) yaitu jenis Yorkshire dengan kode ring kaki TKF (Turki), FPO (Portugal), FOI (Italia)dan kenari Yorkshire Lokal yang sudah pernah menjuarai beberapa even lokal, regional, dan nasional. Sedangkan indukan betina dengan kode ring kaki NB (Belanda), IOA (Inggris), dan beberapa kenari turunan F1, F2, F3, dan kenari lokal. Dengan kandang sebanyak 18 kandang, penangkaran Gienz Bird Farm menggunakan sistem soliter yaitu satu indukan jantan dipasangkan dengan beberapa indukan betina.<br/> 

Untuk burung <b>lovebird</b>, penangkaran dengan sistem kandang koloni yang dihuni beberapa burung lovebird jenis lokal dengan jenis lutino mata merah, pastel biru, pastel ijo, fishery, dan warna-warna lain.
</em></p>
    ...
    <section class="probootstrap_section bg-light">
      <div class="container">
        <div class="row text-center mb-5 probootstrap-animate">
          <div class="col-md-12">
            <h2 class="display-4 border-bottom probootstrap-section-heading">Spesifikasi Indukan Murai</h2>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="media probootstrap-media d-flex align-items-stretch mb-4 probootstrap-animate">
              <div class="media-body">
                ...
                <h5 class="mb-3">Kandang 1</h5>
                  <p>
                    Jenis jantan		: Murai Bahorok panjang ekor 23 cm <br/>
                    Jenis Betina		: Murai medan panjang ekor 14 cm<br/>
                    Isian jantan		: Gereja, prenjak, lovebird, cililin<br/>
                    Prestasi			: Juara 1 dan 4 tingkat regional, Juara di beberapa even lokal<br/>
                  </p>
              </div>
            </div>
            ...
            <div class="media probootstrap-media d-flex align-items-stretch mb-4 probootstrap-animate">
              ...
              <div class="media-body">
                <span class="text-uppercase">Murai Batu</span>
                <h5 class="mb-3">Kandang 2</h5>
                  <p>
                    Jenis jantan		: Murai Medan panjang ekor 19 cm<br/>
                    Jenis Betina		: Murai Medan  panjang ekor 13 cm<br/>
                    Isian jantan		: Kenari, tengkek, cililin<br/>
                    Prestasi			: Juara di beberapa even lokal<br/>
          ...
          <div class="col-md-6">
            <div class="media probootstrap-media d-flex align-items-stretch mb-4 probootstrap-animate">
              <div class="media-body">
   <span class="text-uppercase">Murai Batu</span>
                <h5 class="mb-3">Kandang 4</h5>
                  <p>
                    Jenis jantan		: Murai Medan Super panjang ekor 22 cm<br/>
                    Jenis Betina		: Murai Medan panjang ekor 14 cm<br/><br/>
                    Isian jantan		: Cucak jenggot, lovebird, cililin<br/>
                    Prestasi			: Juara di beberapa even lokal<br/>
                  </p>
              ...
              <div class="media-body">
  <span class="text-uppercase">Murai Batu</span>
                <h5 class="mb-3">Kandang 5</h5>
                  <p>
                    Jenis jantan		: Murai Medan panjang ekor 20 cm
                    Jenis Betina		: Murai Medan  panjang ekor 14 cm
                    Isian jantan		: Ciblek, cucak jenggot, cililin
                    Prestasi			: Juara di beberapa even lokal
            ...
            <div class="media probootstrap-media d-flex align-items-stretch mb-4 probootstrap-animate">
              ...
              <div class="media-body">
               <span class="text-uppercase">Murai Batu</span>
                <h5 class="mb-3">Kandang 3</h5>
                  <p>
                    Jenis jantan		: Murai Bahorok-Marike panjang ekor 20 cm<br/>
                    Jenis Betina		: Murai medan panjang ekor 15 cm<br/>
                    Isian jantan		: Ciblek, kenari, cililin<br/>
                    Prestasi			: Juara 2 tingkat regional, Juara di beberapa even lokal<br/>
    ...
    <section class="probootstrap_section bg-light" id="section-contact">
      <div class="container">
        <div class="row text-center mb-5 probootstrap-animate">
          <div class="col-md-12">
            <h2 class="display-4 border-bottom probootstrap-section-heading">Booking Form</h2>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6 probootstrap-animate">
            <p class="mb-5">Setelah melakukan booking silahkan tunggu 1x24 jam untuk menerima telepon konfirmasi dari kami. Anda dapat melakukan cek status booking maupun histori booking anda pada panel <a href="<?php echo base_url(). 'Welcome/history'; ?>">history</a> diatas</p>
              <p class="mb-5">Untuk pertanyaan lebih lanjut silahkan hubungi kami di bawah ini :</p>
            <div class="row">
              <div class="col-md-6">
          ...
          <div class="col-md-6  probootstrap-animate">
            <form action="<?php echo base_url(). 'User/go_book'; ?>" method="post" class="probootstrap-form probootstrap-form-box mb60">
              ...
              <div class="form-group">
                ...
                <textarea cols="30" rows="10" class="form-control" id="message" name="catatan" placeholder="Catatan (tulis Kandang berapa untuk pemesanan murai batu)"></textarea>
              </div>
              <div class="form-group">
