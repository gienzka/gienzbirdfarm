    ...
    <section class="probootstrap_section bg-light">
      <div class="container">
        <div class="row text-center mb-5 probootstrap-animate">
          <div class="col-md-12">
            <h2 class="display-4 border-bottom probootstrap-section-heading">Spesifikasi Indukan</h2>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6">
              ...
              <div class="row mb-3">
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="fname" class="sr-only sr-only-focusable">Induk Jantan</label>
                    <input type="text" class="form-control" id="fname" name="indukJ" placeholder="Induk Jantan">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="lname" class="sr-only sr-only-focusable">Induk Betina</label>
                    <input type="text" class="form-control" id="lname" name="indukB" placeholder="Induk Betina">
                  </div>
                </div>
              </div>
              <div class="form-group">
