          		...
          		<div class="col-lg-12">
				            <div>
                              ...
                              <div class="col-lg-5 col-md-8">
                                ...
                                <h4>Upload Trophy</h4>
                                <form action="<?php echo base_url(). 'CrudAdmin/uploadtrophy'; ?>" method="post" enctype="multipart/form-data">
                                ...
                                <h4>Update Trophy</h4>
                                <form action="<?php echo base_url(). 'CrudAdmin/updatetrophy'; ?>" method="post">
                                    Judul : <input type="text" name="judul" class="form-control" required><br>
                                    Deskripsi : <textarea name="deskripsi" cols="30" rows="10" class="form-control" required></textarea>
                                    ID : <input type="text" name="id" class="form-control" required><br>
                                ...
                                <h4>Delete Trophy</h4>
                                <form action="<?php echo base_url(). 'CrudAdmin/deletetrophy'; ?>" method="post">
