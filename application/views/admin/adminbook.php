          ...
          <section class="wrapper site-min-height">
            ...
            <br/><br/>
                    ...
                    <br/><br/>
                                <div>
                                <table class="table">
                                    <h4>Antrian Kenari Yorkshire</h4>
                                  <thead>
                                    <tr>
                                        <th scope="col">No</th>
                                        <th scope="col">Kode Booking</th>
                    ...
                    <br/><br/>
                            <div>
                              ...
                              <div class="col-lg-5 col-md-8">
                                ...
                                <h4>Update Data</h4>
                                <form action="<?php echo base_url(). 'CrudAdmin/updatebook'; ?>" method="post">
                                ...
                                <h4>Delete Data</h4>
                                <form action="<?php echo base_url(). 'CrudAdmin/deletebook'; ?>" method="post">
