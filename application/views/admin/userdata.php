      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      <a class="active" href="<?php echo base_url(). 'Welcome/userdata'; ?>" >
				            ...
				            <div>
                                <table class="table">
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td><img alt="profilephoto" height="50px" width="50px" src="<?php echo base_url().$u->photo ?>"></td>
                                    </tr>
                                      <?php } ?>
                                  </tbody>
                                </table>
                              ...
                              <div class="col-lg-5 col-md-8">
                                <div class="form">
                                    ...
                                    <h4>Update Data</h4>
                                <form action="<?php echo base_url(). 'CrudAdmin/update'; ?>" method="post">
                                ...
                                <h4>Delete Data</h4>
                                <form action="<?php echo base_url(). 'CrudAdmin/delete'; ?>" method="post">
                                    Email  : <input type="email" name="email" class="form-control"><br>
                                    <input type="hidden" name="table" value="gbf_user">
