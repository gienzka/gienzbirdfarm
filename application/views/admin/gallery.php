          		...
          		<div class="col-lg-12">
				            <div>
                                <table class="table">
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td><img alt="photo gallery" height="50px" width="50px" src="<?php echo base_url().$g->photo ?>"></td>
                                    </tr>
                                      <?php } ?>
                                  </tbody>
                                </table>
                              ...
                              <div class="col-lg-5 col-md-8">
                                ...
                                <form action="<?php echo base_url(). 'CrudAdmin/uploadgallery'; ?>" method="post" enctype="multipart/form-data">
                                    ID : <input type="text" name="id" class="form-control" required><br>
                                    Judul : <input type="text" name="judul" class="form-control" required><br>
                                    Deskripsi : <textarea name="deskripsi" cols="30" rows="10" class="form-control" required></textarea>
                                ...
                                <form action="<?php echo base_url(). 'CrudAdmin/updategallery'; ?>" method="post">
                                    Judul : <input type="text" name="judul" class="form-control" required><br>
                                    Deskripsi : <textarea name="deskripsi" cols="30" rows="10" class="form-control" required></textarea>
                                    ID : <input type="text" name="id" class="form-control" required><br>
                                ...
                                <form action="<?php echo base_url(). 'CrudAdmin/deletegallery'; ?>" method="post">
                                    ID  : <input type="text" name="id" class="form-control"><br>
                                    <input type="submit" value="Delete" class="btn btn-warning">
                                    <input type="hidden" name="table" value="gbf_gallery">
                                </form>
